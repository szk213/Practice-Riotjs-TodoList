...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = function () {
	    ...
	    Todo.prototype.getId = function getId() {
	        return this._id;
	    };

	    Todo.prototype.isChecked = function isChecked() {
	        return this._check;
	    };

	    Todo.prototype.check = function check() {
	        this._check = true;
	    };

	    Todo.prototype.unCheck = function unCheck() {
	        this._check = false;
	    };

	    Todo.prototype.getText = function getText() {
	        return this._text;
	    };

	    Todo.prototype.setText = function setText(text) {
	        this._text = text;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('todo', '<input type="checkbox" __checked="{todo.isChecked();}"> <div>{todo.getText();}</div>', '', '', function (opts) {
	    this.todo = opts.todo || new _Todo2.default();
	    this.mixin(_Todo2.default);
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
